...
def test_EVDI(opt):
    ...
    with torch.no_grad():
        for k in range(0, len(testDataset)):
            ...
            res_name = current_save_path + 'Result/' + prefix + '.png'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_path", type=str, default="./Database/RBE/test/", help="test data path")
    parser.add_argument("--save_path", type=str, default="./Result/EVDI-RBE/", help="saving path")
    parser.add_argument("--roiTL", type=tuple, default=(2,13), help="coordinate of the top-left pixel in region of interest")
    parser.add_argument("--roi_size", type=tuple, default=(256,320), help="size of region of interest")
